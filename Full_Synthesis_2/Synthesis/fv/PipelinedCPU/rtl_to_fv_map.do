...
# Generated on: Sun Feb 25 02:35:28 CST 2024 (Sun Feb 25 08:35:28 GMT 2024)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/PipelinedCPU/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/PipelinedCPU -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k risc_takers_v3.v
elaborate_design -golden -root {PipelinedCPU} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/PipelinedCPU/fv_map.v.gz
elaborate_design -revised -root {PipelinedCPU}
...
#add_name_alias fv/PipelinedCPU/fv_map.singlebit.original_name.alias.json.gz -revised
