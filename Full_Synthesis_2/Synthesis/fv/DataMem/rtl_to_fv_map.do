...
# Generated on: Sun Feb 25 03:03:16 CST 2024 (Sun Feb 25 09:03:16 GMT 2024)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/DataMem/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/DataMem -revised fv_map
...
elaborate_design -golden -root {DataMem} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/DataMem/fv_map.v.gz
elaborate_design -revised -root {DataMem}
...
#add_name_alias fv/DataMem/fv_map.singlebit.original_name.alias.json.gz -revised
