...
# Generated on: Sun Feb 25 02:27:11 CST 2024 (Sun Feb 25 08:27:11 GMT 2024)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/RegFile/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/RegFile -revised fv_map
...
elaborate_design -golden -root {RegFile} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/RegFile/fv_map.v.gz
elaborate_design -revised -root {RegFile}
...
#add_name_alias fv/RegFile/fv_map.singlebit.original_name.alias.json.gz -revised
