...
# Generated on: Sun Feb 25 02:26:40 CST 2024 (Sun Feb 25 08:26:40 GMT 2024)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/InstMem/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/InstMem -revised fv_map
...
elaborate_design -golden -root {InstMem} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/InstMem/fv_map.v.gz
elaborate_design -revised -root {InstMem}
