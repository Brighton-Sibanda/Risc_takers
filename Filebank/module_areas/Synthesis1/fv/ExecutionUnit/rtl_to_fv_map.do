...
# Generated on: Tue Feb 13 05:18:15 CST 2024 (Tue Feb 13 11:18:15 GMT 2024)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/ExecutionUnit/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/ExecutionUnit -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k behav_exec_unit_synth.v
elaborate_design -golden -root {ExecutionUnit} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/ExecutionUnit/fv_map.v.gz
elaborate_design -revised -root {ExecutionUnit}
...
#add_name_alias fv/ExecutionUnit/fv_map.singlebit.original_name.alias.json.gz -revised
